...
test('（2日目 8:00）', () => {
    expect(getPickUpProjectId(moment("2020-11-01 08:00"))).toBe(8);
});

test('（2日目 9:00）', () => {
    expect(getPickUpProjectId(moment("2020-11-01 09:00"))).toBe(8);
});

test('（2日目 10:00）', () => {
    expect(getPickUpProjectId(moment("2020-11-01 10:00"))).toBe(9);
});

test('（2日目 11:00）', () => {
    expect(getPickUpProjectId(moment("2020-11-01 11:00"))).toBe(9);
});

test('大学祭終了後', () => {
    expect(getPickUpProjectId(moment("2020-11-02"))).toBe(13);
});